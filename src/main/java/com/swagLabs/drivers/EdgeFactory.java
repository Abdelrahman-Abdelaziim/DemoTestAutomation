...
public class EdgeFactory extends AbstractDriver implements WebDriverOptionsAbstract<EdgeOptions>{
    ...
    public EdgeOptions getOptions() {
        ...
        edgeOptions.addArguments("--start-maximized"); // Starts Chrome in maximized mode
        ...
        Map<String, Object> prefsEdge = Map.of("profile.default_content_setting_values.notifications", 2,
